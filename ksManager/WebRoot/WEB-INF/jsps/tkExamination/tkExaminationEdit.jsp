									...
									<div class="row-fluid">
										<div class="span8" style="background-color: #fff;">
											<div class="control-group"> 
											   ...
											   <div class="controls">
											        <textarea id="examinationContent" name="examinationContent" class="span11 wysihtml5 m-wrap" rows="8" >${tkExamination.examinationContent}</textarea>
											...
											<div class="control-group">
											   <label class="control-label"> 
											       选项/答案<span class="">*</span>
											       <div>
											            <c:if test="${tkExamination.typeCode == 'danx' || tkExamination.typeCode == 'duox' || tkExamination.typeCode == 'tiank'}">
															<select id="optionNum" name="optionNum" class="span8" data-placeholder="选项个数" tabindex="1" onchange="optionNumChange();">
											   ...
											   <div class="controls">
												   ...
												   <c:if test="${tkExamination.typeCode=='jiand' }">
												       ...
												       <div>请输入答案关键字，支持多个关键字，按Enter回车键录入完成。</div>
												       <script>
										...
										<div class="span4" style="background-color: #fff;">
											<div class="control-group"> 
											   <label class="control-label"> 
											       课程<span class="">*</span> 
											   </label> 
											   <div class="controls"> 
											       <select id="courseId" name="courseId" class="span12 m-wrap ">
											       		<option value="" ></option>
											...
											<div class="control-group"> 
											   ...
											   <div class="controls"> 
											       <select id="typeCode" name="typeCode" class="span6 m-wrap ">
											       		<option value="" ></option>
