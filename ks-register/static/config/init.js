...
;(function() {
  var resList = {
    ...
    css: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/css/idangerous.swiper.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/popover.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/style.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/style-d0cb3c0e89.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/style.min.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/website-base.css',
      window.SITE_CONFIG.cdnUrl + '/static/css/website-home.css',
    ],
    js: [
