	...
	<@ms.modal modalName="addEditModel" title="添加模块">
		<@ms.modalBody height="350">
			<@ms.form isvalidation=true name="addEditForm"  action="" method="post"  >
				...
				<@ms.text name="modelCode"  label="编码" title="模块编码" placeholder="请输入模块编码" value="" maxlength="50" validation={"required":"true", "data-bv-notempty-message":"请输入模块编码!","data-bv-regexp":"true","data-bv-regexp-regexp":'^[A-Za-z0-9]+$',"data-bv-regexp-message":"模块编码只能为英文字母，数字!"} />
